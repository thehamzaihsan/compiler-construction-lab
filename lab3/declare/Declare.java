/* Declare.java */
/* Generated By:JavaCC: Do not edit this line. Declare.java */
import java.io.*;
...
public class Declare implements DeclareConstants {
  //  private static HashMap<Object,Object> symTab = new HashMap<>();
    private static Symbol symTab = new Symbol();
...
// Grammar rule for a single declaration
  final public void Declaration() throws ParseException {Token id, var;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INT:{
...
symTab.put(var.image, id.image);
  ...
  public DeclareTokenManager token_source;
  ...
  public Declare(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Declare(java.io.InputStream stream, String encoding) {
	 try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
	 token_source = new DeclareTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public Declare(java.io.Reader stream) {
 ...
 token_source = new DeclareTokenManager(jj_input_stream);
  ...
  public Declare(DeclareTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(DeclareTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
